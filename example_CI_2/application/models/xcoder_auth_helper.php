 ...
 * @author Xcoder
 */
class xcoder_auth_helper extends CI_Model{
   ...
   function mail_sender()
   {
            ...
            $this->email->message('Click the link to activate your account'.anchor('http://localhost/example_CI_2/index.php/xcoder_auth/xcoder_auth/conf/'.  $xcoder_passkey));
            if($this->email->send())
            {
